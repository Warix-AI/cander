...
- **Knowledge route:** `LOCAL` | `WEB_REQUIRED` | `UNCERTAIN` before tools (no numeric confidence). Auto: LOCAL answers locally; WEB_REQUIRED/UNCERTAIN → Exa Deep. Composer override `browserMode` / `cander:web-mode`: Auto | On | Off.
