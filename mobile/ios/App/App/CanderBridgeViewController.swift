...
class CanderBridgeViewController: CAPBridgeViewController {
    ...
    override open func capacitorDidLoad() {
        ...
        // Keep WKWebView opaque white so iOS never shows a dark status-bar scrim
        // behind the transparent mobile chrome.
        ...
        bridge?.registerPluginInstance(CanderPhotosPlugin())
        disableRootBounce()
