...
const RULES: { re: RegExp; out: string | null }[] = [
  ...
  { re: /finding the right (website )?design|reviewing (website templates|design options)|preparing your (design|website structure)|customizing (the template|your design)/i, out: "Finding the right design…" },
  { re: /design resources (are )?temporarily unavailable|ui_source_unavailable/i, out: "Design resources are temporarily unavailable. Try again." },
  { re: /checking visual consistency|ui.source|ui provenance/i, out: "Checking visual consistency…" },
  { re: /finding a section for your needs|adding the sections you need/i, out: "Adding the sections you need…" },
  { re: /adding your content/i, out: "Adding your content…" },
