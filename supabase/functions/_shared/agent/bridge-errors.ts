/**
 * Sanitize AI bridge / tunnel errors for user-facing surfaces.
 * Keep in sync with lib/ai/bridge-errors.ts
 */
...
/** Safe user-visible text — never pass through HTML or long upstream bodies. */
